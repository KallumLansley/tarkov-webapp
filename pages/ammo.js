...
import AmmoTutorial from "../components/AmmoTutorial";
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const tutorialCompleted = localStorage.getItem('ammoTutorialCompleted') === 'true';
  ...
  return (
    <div className={`${styles.container} ${isTutorialActive ? styles.pageDimmed : ''}`}>
      {/* Tutorial overlay */}
      {isTutorialActive && <AmmoTutorial onComplete={handleTutorialComplete} />}
